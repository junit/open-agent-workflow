...
//go:embed schemas/v4/execution-graph.schema.json schemas/v4/host-conformance-report.schema.json schemas/v4/host-conformance-transcript.schema.json schemas/v4/provider-descriptor.schema.json providers/*.json recipes/*.json audits/*.json conformance/*.json profile-aliases.json profile-matrix.json host-integrations.json
